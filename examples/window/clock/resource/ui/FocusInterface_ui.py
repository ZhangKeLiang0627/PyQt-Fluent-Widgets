...
class Ui_FocusInterface(object):
    def setupUi(self, FocusInterface):
        ...
        icon = QIcon()
        icon.addFile(u":/images/tips.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.progressIcon.setIcon(icon)

        self.horizontalLayout_4.addWidget(self.progressIcon)

        self.horizontalSpacer_8 = QSpacerItem(2, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)
        ...
        self.verticalSpacer_16 = QSpacerItem(20, 3, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/images/alarms.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.hintLabel.setProperty(u"lightColor", QColor(96, 96, 96))
        self.hintLabel.setProperty(u"darkColor", QColor(206, 206, 206))
        ...
        icon2 = QIcon()
        icon2.addFile(u":/images/todo.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.taskCardIcon.setIcon(icon2)

        self.horizontalLayout_7.addWidget(self.taskCardIcon)

        self.horizontalSpacer_7 = QSpacerItem(2, 2, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)
        ...
        self.verticalSpacer_8 = QSpacerItem(20, 3, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)
        ...
        self.hintLabel_2.setProperty(u"lightColor", QColor(96, 96, 96))
        self.hintLabel_2.setProperty(u"darkColor", QColor(206, 206, 206))
        ...
        self.taskLabel1.setProperty(u"pixelFontSize", 14)
        self.taskLabel1.setProperty(u"strikeOut", True)
